...
class Trader:
    ...
    def picnic1_strategy(self, state: TradingState, limit: int, stored_data):
        ...
        z_trade = True
        window = 30
        z_score_threshold = 5 #changing z-score from 30 -> 5; pnl is 28K->38K
    ...
    def picnic2_strategy(self, state: TradingState, limit: int, stored_data):
        ...
        z_trade = True
        window = 20
        z_score_threshold = 40 #changed from 60->40; pnl from 38k->66k
    ...
    def djembes_strategy(self, state: TradingState, limit: int, stored_data):
        ...
        z_trade = True
        window = 30
        z_score_threshold = 10 #changed from 30->10; pnl 66k->102k
