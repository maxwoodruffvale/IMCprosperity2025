...
class Trader:
    ...
    def picnic1_strategy(self, state: TradingState, limit: int, stored_data, first: bool):
        ...
        if z_trade:
            ...
            if spread_std == 0:
                ...
                z_score = (spread - 29.25101) / spread_std
    ...
    def picnic2_strategy(self, state: TradingState, limit: int, stored_data, first: bool):
        ...
        if z_trade:
            ...
            if spread_std == 0:
                ...
                z_score = (spread - 44.98941) / spread_std
    ...
    def djembes_strategy(self, state: TradingState, limit: int, stored_data, first: bool):
        ...
        if z_trade:
            ...
            if spread_std == 0:
                ...
                z_score = (spread - 38.233105) / spread_std
    ...
    def spread_picker(self,
        ...
        if arb1_exists:
            ...
            try:
                ...
                spread1 = picnic1_fair_value - synthetic1_fair_value - 29.25101
            except:
                spread1 = 0
        else:
            spread1 = 0
        ...
        if arb2_exists:
            ...
            try:
                ...
                spread2 = picnic2_fair_value - synthetic2_fair_value - 44.98941
            except:
                spread2 = 0
        else:
            spread2 = 0
        ...
        if arb3_exists:
            ...
            try:
                ...
                spread3 = djembes_fair_value - synthetic3_fair_value - 38.233105
            except:
                spread3 = 0
        else:
            spread3 = 0
    ...
    def voucher_strategy(self,
        ...
        # make it 4 - timestamp / 10000 durinig submission
    ...
    def run(self, state: TradingState):
        ...
        for product in ["RAINFOREST_RESIN",
            ...
            if product == "MAGNIFICENT_MACARONS":
                result["MAGNIFICENT_MACARONS"], conversions = self.macarons_strategy(state, POSITION_LIMITS["MAGNIFICENT_MACARONS"])
