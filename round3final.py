...
class Trader:
    ...
    def v9500_strategy(
        ...
        iv_mean = np.mean(stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"])
        iv_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"])
        if iv_std == 0:
            return orders
    ...
    def v9750_strategy(
        ...
        iv_mean = np.mean(stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"])
        iv_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"])
        if iv_std == 0:
            return orders
    ...
    def v10000_strategy(
        ...
        iv_mean = np.mean(stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"])
        iv_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"])
        if iv_std == 0:
            return orders
    ...
    def v10250_strategy(
        ...
        position = state.position[
            "VOLCANIC_ROCK_VOUCHER_10250"] if "VOLCANIC_ROCK_VOUCHER_10250" in state.position else 0
        ...
        iv_mean = np.mean(stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"])
        iv_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"])
        if iv_std == 0:
            return orders
    ...
    def v10500_strategy(
        ...
        position = state.position[
            "VOLCANIC_ROCK_VOUCHER_10500"] if "VOLCANIC_ROCK_VOUCHER_10500" in state.position else 0
        ...
        iv_mean = np.mean(stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"])
        iv_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"])
        if iv_std == 0:
            return orders
