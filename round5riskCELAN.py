...
class Trader:
    ...
    def rock_strategy(
        ...
        # 100 2
        # Round 5 day 2: 195,637
        # Round 5 day 3: 93,108
        # Round 5 day 4: 55,433
        # Total profit: 344,178

        # 150 1.5
        # Round 5 day 2: 124,298
        # Round 5 day 3: 82,269
        # Round 5 day 4: 77,896
        # Total profit: 284,463
    ...
    def voucher_strategy(self,
        ...
        alpha = 2.0 / (window + 1)
        try:
            ewma_iv = alpha * iv + (1 - alpha) * stored_data[product]["ewma_iv_prev"]
            ewma_var = alpha * (iv - ewma_iv)**2 + (1 - alpha) * stored_data[product]["ewma_var_prev"]
        except:
            ewma_iv = iv
            ewma_var = 0.0
        stored_data[product]["ewma_iv_prev"] = ewma_iv
        stored_data[product]["ewma_var_prev"] = ewma_var
        ...
        z_score = (iv - ewma_iv) / math.sqrt(ewma_var)
    ...
    def macarons_strategy(self, state: TradingState):
    ...
    def run(self, state: TradingState):
        ...
        for product in ["RAINFOREST_RESIN",
            ...
            if product == "PICNIC_BASKET1":
                croissants_orders, picnic1_orders, picnic2_orders = self.picnic_olivia_strategy(state,
                                                                                                POSITION_LIMITS["CROISSANTS"], POSITION_LIMITS["PICNIC_BASKET1"], POSITION_LIMITS["PICNIC_BASKET2"])
            ...
            if product == "VOLCANIC_ROCK_VOUCHER_10250":
                result["VOLCANIC_ROCK_VOUCHER_10250"] = self.voucher_strategy(state,
                                                                           POSITION_LIMITS[
                                                                               "VOLCANIC_ROCK_VOUCHER_10250"],
                                                                              stored_data,
                                                                             "VOLCANIC_ROCK_VOUCHER_10250",
            ...
            if product == "VOLCANIC_ROCK_VOUCHER_10500":
                result["VOLCANIC_ROCK_VOUCHER_10500"] = self.voucher_strategy(state,
                                                                           POSITION_LIMITS[
                                                                               "VOLCANIC_ROCK_VOUCHER_10500"],
                                                                              stored_data,
                                                                             "VOLCANIC_ROCK_VOUCHER_10500",
            ...
            if product == "MAGNIFICENT_MACARONS":
                result["MAGNIFICENT_MACARONS"], conversions = self.macarons_strategy(state)
