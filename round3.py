...
class Trader:
    ...
    def picnic1_strategy(self, state: TradingState, limit: int, stored_data, first: bool):
        ...
        if z_trade:
            ...
            if spread_std == 0:
                ...
                z_score = (spread - 60.7282625) / spread_std
    ...
    def picnic2_strategy(self, state: TradingState, limit: int, stored_data, first: bool):
        ...
        if z_trade:
            ...
            if spread_std == 0:
                ...
                z_score = (spread - 31.44805) / spread_std
    ...
    def djembes_strategy(self, state: TradingState, limit: int, stored_data, first: bool):
        ...
        if z_trade:
            ...
            if spread_std == 0:
                ...
                z_score = (spread + 13.5561875) / spread_std
    ...
    def spread_picker(self,
        ...
        if arb1_exists:
            ...
            try:
                ...
                spread1 = picnic1_fair_value - synthetic1_fair_value - 60.7282625
            except:
                spread1 = 0
        else:
            spread1 = 0
        ...
        if arb2_exists:
            ...
            try:
                ...
                spread2 = picnic2_fair_value - synthetic2_fair_value - 31.44805
            except:
                spread2 = 0
        else:
            spread2 = 0
        ...
        if arb3_exists:
            ...
            try:
                ...
                spread3 = djembes_fair_value - synthetic3_fair_value + 13.5561875
            except:
                spread3 = 0
        else:
            spread3 = 0
    ...
    def v9500_strategy(
        ...
        order_depth = state.order_depths["VOLCANIC_ROCK_VOUCHER_9500"]
        rock_order_depth = state.order_depths["VOLCANIC_ROCK"]

        position = state.position["VOLCANIC_ROCK_VOUCHER_9500"] if "VOLCANIC_ROCK_VOUCHER_9500" in state.position else 0
        ...
        # make it 5 - timestamp / 10000 durinig submission
        T = (8 - timestamp / 10000) / 365

        iv = self.find_vol(fair_value, rock_fair_value, 9500, T, 0)

        m = math.log(9500 / rock_fair_value) / math.sqrt(T)

        predicted_iv = 0.25350824 * (m ** 2) + 0.00219237 * m + 0.14874006

        spread = iv - predicted_iv

        window = 50
        z_threshold = 2.5
        stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"].append(spread)
        if len(stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"]) < 5:
            return orders
        elif len(stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"]) > window:
            stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"].pop(0)

        spread_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_9500"]["spread_history"])
        ...
        if z_score > z_threshold:
            ...
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_9500", best_bid, -volume))
        ...
        # buying options
            ...
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_9500", best_ask, volume))
    ...
    def v9750_strategy(
        ...
        order_depth = state.order_depths["VOLCANIC_ROCK_VOUCHER_9750"]
        rock_order_depth = state.order_depths["VOLCANIC_ROCK"]

        position = state.position["VOLCANIC_ROCK_VOUCHER_9750"] if "VOLCANIC_ROCK_VOUCHER_9750" in state.position else 0
        ...
        iv = self.find_vol(fair_value, rock_fair_value, 9750, T, 0)

        m = math.log(9750 / rock_fair_value) / math.sqrt(T)
        ...
        window = 50
        z_threshold = 4
        stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"].append(spread)
        if len(stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"]) < 5:
            return orders
        elif len(stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"]) > window:
            stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"].pop(0)

        spread_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_9750"]["spread_history"])
        ...
        if z_score > z_threshold:
            ...
            volume = min(possible_volume, max_sell)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_9750", best_bid, -volume))
        ...
        # buying options
            ...
            volume = min(possible_volume, max_buy)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_9750", best_ask, volume))
    ...
    def v10000_strategy(
        ...
        order_depth = state.order_depths["VOLCANIC_ROCK_VOUCHER_10000"]
        rock_order_depth = state.order_depths["VOLCANIC_ROCK"]

        position = state.position["VOLCANIC_ROCK_VOUCHER_10000"] if "VOLCANIC_ROCK_VOUCHER_10000" in state.position else 0
        ...
        iv = self.find_vol(fair_value, rock_fair_value, 10000, T, 0)

        m = math.log(10000 / rock_fair_value) / math.sqrt(T)
        ...
        window = 50
        z_threshold = 5
        stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"].append(spread)
        if len(stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"]) < 5:
            return orders
        elif len(stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"]) > window:
            stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"].pop(0)

        spread_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_10000"]["spread_history"])
        ...
        if z_score > z_threshold:
            ...
            volume = min(possible_volume, max_sell)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_10000", best_bid, -volume))
        ...
        # buying options
            ...
            volume = min(possible_volume, max_buy)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_10000", best_ask, volume))
    ...
    def v10250_strategy(
        ...
        order_depth = state.order_depths["VOLCANIC_ROCK_VOUCHER_10250"]
        rock_order_depth = state.order_depths["VOLCANIC_ROCK"]

        position = state.position["VOLCANIC_ROCK_VOUCHER_10250"] if "VOLCANIC_ROCK_VOUCHER_10250" in state.position else 0
        ...
        m = math.log(10250 / rock_fair_value) / math.sqrt(T)
        ...
        window = 50
        z_threshold = 4
        stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"].append(spread)
        if len(stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"]) < 5:
            return orders
        elif len(stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"]) > window:
            stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"].pop(0)

        spread_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_10250"]["spread_history"])
        ...
        if z_score > z_threshold:
            ...
            volume = min(possible_volume, max_sell)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_10250", best_bid, -volume))
        ...
        # buying options
            ...
            volume = min(possible_volume, max_buy)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_10250", best_ask, volume))
    ...
    def v10500_strategy(
        ...
        order_depth = state.order_depths["VOLCANIC_ROCK_VOUCHER_10500"]
        rock_order_depth = state.order_depths["VOLCANIC_ROCK"]

        position = state.position["VOLCANIC_ROCK_VOUCHER_10500"] if "VOLCANIC_ROCK_VOUCHER_10500" in state.position else 0
        ...
        m = math.log(10500 / rock_fair_value) / math.sqrt(T)
        ...
        window = 50
        z_threshold = 4
        stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"].append(spread)
        if len(stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"]) < 5:
            return orders
        elif len(stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"]) > window:
            stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"].pop(0)

        spread_std = np.std(stored_data["VOLCANIC_ROCK_VOUCHER_10500"]["spread_history"])
        ...
        if z_score > z_threshold:
            ...
            volume = min(possible_volume, max_sell)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_10500", best_bid, -volume))
        ...
        # buying options
            ...
            volume = min(possible_volume, max_buy)
            if volume > 0:
                orders.append(Order("VOLCANIC_ROCK_VOUCHER_10500", best_ask, volume))
    ...
    def run(self, state: TradingState):
        ...
        for product in ["RAINFOREST_RESIN",
            ...
            #     result["VOLCANIC_ROCK_VOUCHER_9750"] = self.v9750_strategy(state,
            #                                                                POSITION_LIMITS[
            #                                                                    "VOLCANIC_ROCK_VOUCHER_9750"],
            #                                                                stored_data,
            #                                                                )
