...
class Trader:
        ...
        if arb1_exists:
            ...
            try:
                if picnic1_first:
                    ...
                    picnic1_fair_value = stored_data["PICNIC_BASKET1"]["fair_value"]
        ...
        if arb2_exists:
            ...
            try:
                if picnic2_first:
                    ...
                    picnic2_fair_value = stored_data["PICNIC_BASKET2"]["fair_value"]
    ...
    # def v9500_strategy(self, state: TradingState, limit: int, stored_data):
